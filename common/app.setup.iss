...
Name: "PLC\TwinCAT\TC3_1_4024_15"; Description: "3.1.4024.15"; Flags: exclusive; Types: full
...
Source: "..\plc_TC3.1.4024.15_default\*"; DestDir: "{app}\plc\plc_TC3.1.4024.15_default\"; Flags: ignoreversion recursesubdirs;
...
begin
  ...
  // Add items
  //HardwareConfigPage.Add('TC3.1.4024.15_default');
...
begin
  ...
  begin
    ...
    if WizardIsComponentSelected('PLC\TwinCAT\TC3_1_4024_15') then
    begin
      SelectedTwinCAT := 'TC3.1.4024.15'
    end;
